...
print(len(d4))
print(len(d5))
d1.to_csv('BR1.csv', index = False, sep='\t', encoding='utf8')
d2.to_csv('BR2.csv', index = False, sep='\t', encoding='utf8')
d3.to_csv('BR3.csv', index = False, sep='\t', encoding='utf8')
d4.to_csv('BR4.csv', index = False, sep='\t', encoding='utf8')
d5.to_csv('BR5.csv', index = False, sep='\t', encoding='utf8')
